...
### 1.1 Python 32-bit (pre supplier-invoice-loader)
...
### 5.1 venv32 (pre supplier-invoice-loader service)
...
$migrations = @(
    "apps/supplier-invoice-loader/database/migrations/001_supplier_invoice_staging.sql",
    "apps/supplier-invoice-loader/database/migrations/002_add_nex_columns.sql",
...
```powershell
# Upraviť apps/supplier-invoice-loader/config/config_customer.py
...
```powershell
# Upraviť apps/supplier-invoice-loader/config/config.yaml
...
# SQLite backup
Copy-Item apps\supplier-invoice-loader\config\invoices.db backup\
```
