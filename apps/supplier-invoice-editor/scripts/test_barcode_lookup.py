...
class BarcodeLookupService:
    ...
    def _find_barcode(self, ean: str) -> BarcodeRecord | None:
    ...
    def _find_product_by_barcode(self, ean: str) -> GSCATRecord | None:
    ...
    def _find_product_by_plu(self, gs_code: int) -> GSCATRecord | None:
    ...
    def check_invoice_items(self, items: list[dict]) -> dict:
        ...
        """
        results = {"total": len(items), "found": 0, "not_found": 0, "items": []}
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--from-xml":
        ...
        for idx, ean in enumerate(ean_codes, 1):
            ...
            if result:
                ...
                print("   MISSING NIE JE v NEX Genesis")
