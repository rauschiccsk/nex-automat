...
class TestDocumentEndpoints:
    ...
    def test_list_documents(
        self, mock_get_repo, api_v1_client, mock_tsh_repository, api_key_header
    ):
    ...
    @patch("src.api.routes.documents.get_tsh_repository")
    def test_list_documents_with_book_id(
        self, mock_get_repo, api_v1_client, mock_tsh_repository, api_key_header
    ):
        ...
        response = api_v1_client.get(
            "/api/v1/documents?book_id=001", headers=api_key_header
        )
    ...
    @patch("src.api.routes.documents.get_tsh_repository")
    def test_list_documents_filter_by_type(
        self, mock_get_repo, api_v1_client, mock_tsh_repository, api_key_header
    ):
        ...
        response = api_v1_client.get(
            "/api/v1/documents?doc_type=1", headers=api_key_header
        )
    ...
    @patch("src.api.routes.documents.get_tsh_repository")
    def test_list_documents_filter_by_partner(
        self, mock_get_repo, api_v1_client, mock_tsh_repository, api_key_header
    ):
        ...
        response = api_v1_client.get(
            "/api/v1/documents?pab_code=101", headers=api_key_header
        )
    ...
    @patch("src.api.routes.documents.get_tsh_repository")
    def test_list_documents_filter_by_date(
        self, mock_get_repo, api_v1_client, mock_tsh_repository, api_key_header
    ):
        ...
        response = api_v1_client.get(
            "/api/v1/documents?date_from=2025-01-01&date_to=2025-01-31",
    ...
    def test_get_document_with_items(
        ...
        response = api_v1_client.get(
            "/api/v1/documents/2025001", headers=api_key_header
        )
    ...
    def test_get_document_not_found(
        ...
        response = api_v1_client.get(
            "/api/v1/documents/UNKNOWN123", headers=api_key_header
        )

        assert response.status_code == 404

    @patch("src.api.routes.documents.get_tsi_repository")
    def test_get_document_items_only(
        self, mock_get_repo, api_v1_client, mock_tsi_repository, api_key_header
    ):
        """Test GET /api/v1/documents/{doc_number}/items returns only items."""
        mock_get_repo.return_value = mock_tsi_repository

        response = api_v1_client.get(
            "/api/v1/documents/2025001/items", headers=api_key_header
        )
    ...
    @patch("src.api.routes.documents.get_tsi_repository")
    def test_get_document_items_not_found(
        self, mock_get_repo, api_v1_client, mock_tsi_repository, api_key_header
    ):
        ...
        response = api_v1_client.get(
            "/api/v1/documents/UNKNOWN123/items", headers=api_key_header
        )
