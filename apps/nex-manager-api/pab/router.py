...
def list_partners(
    ...
    Performance — fast path:
      - Skips pydantic response_model validation (saves ~5-10s on 250k rows)
      - Builds tuples → list[dict] manually (no _row_to_partner per record)
      - orjson serialization (5-10x faster than stdlib json)
