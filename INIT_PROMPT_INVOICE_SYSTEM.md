...
C:\Development\nex-automat\
├── apps\
│   ├── supplier-invoice-loader\    # FastAPI (32-bit)
...
### ANDROS .env (supplier-invoice-loader)
```env
...
| NEX-Automat-Loader | venv32 (32-bit) | apps\supplier-invoice-loader | python -m uvicorn main:app --host 0.0.0.0 --port 8001 |
