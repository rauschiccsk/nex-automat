"""Add QuickSearch integration to grids"""
from pathlib import Path

APP = Path("C:/Development/nex-automat/apps/supplier-invoice-staging")

MAIN_WINDOW = '''"""Main Window - Invoice List with QuickSearch"""
...
ITEMS_WINDOW = '''"""Invoice Items Window with QuickSearch"""
...
print("Updated main_window.py and invoice_items_window.py with QuickSearch")
print("\nRun: python app.py")