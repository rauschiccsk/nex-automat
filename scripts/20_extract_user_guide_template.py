#!/usr/bin/env python3
"""
Script 20: Extract User Guide Template + Archive Mágerstav Version

Migrates MAGERSTAV_ONBOARDING_GUIDE.md-old:
1. Creates generic USER_GUIDE_TEMPLATE.md in docs/deployment/
...
# Paths
REPO_ROOT = Path("C:/Development/nex-automat")
SOURCE = REPO_ROOT / "docs/deployment/MAGERSTAV_ONBOARDING_GUIDE.md-old"
TEMPLATE_NEW = REPO_ROOT / "docs/deployment/USER_GUIDE_TEMPLATE.md"
ARCHIVE = REPO_ROOT / "docs/archive/deployments/USER_GUIDE_MAGERSTAV_2025-12-02.md"
DOC_INDEX = REPO_ROOT / "docs/deployment/DEPLOYMENT_GUIDE.md"
ARCHIVE_INDEX = REPO_ROOT / "docs/archive/00_ARCHIVE_INDEX.md"

# Generic template content
TEMPLATE = r"""# NEX Automat - User Guide Template
...
def main():
    print("=" * 80)
    print("Script 20: Extract User Guide Template + Archive")
    print("=" * 80)
    ...
    print(f"   Purpose: Generic user guide template for any customer")

    # Step 2: Archive customer-specific version
    print("\n" + "=" * 80)
    print("Step 2: Archiving customer-specific version")
    print("=" * 80)
    ...
    print(f"   Customer: Mágerstav s.r.o.")
    print(f"   Version: 2.1 (2025-12-02)")

    # Step 3: Delete original .md-old
    print("\n" + "=" * 80)
    print("Step 3: Deleting original .md-old file")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("Step 4: Index updates needed")
    print("=" * 80)

    print("\n📋 Manual index updates required:")
    print(f"\n1. {ARCHIVE_INDEX}")
    print("   Add under 'Deployment Documentation':")
    print("   - USER_GUIDE_MAGERSTAV_2025-12-02.md - End-user manual (v2.1)")

    print(f"\n2. {DOC_INDEX}")
    print("   Add reference to USER_GUIDE_TEMPLATE.md")
    ...
    print("\n✅ Created:")
    print(f"   - {TEMPLATE_NEW.relative_to(REPO_ROOT)}")
    print(f"\n✅ Archived:")
    print(f"   - {ARCHIVE.relative_to(REPO_ROOT)}")
    print(f"\n✅ Deleted:")
    print(f"   - {SOURCE.relative_to(REPO_ROOT)}")

    print("\n📋 Next steps:")
    print("   1. Update documentation indexes manually")
    print("   2. Review generic template")
