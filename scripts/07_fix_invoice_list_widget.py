"""
Fix: Oprava invoice_list_widget.py - odstránenie hardcoded column widths
Reason: BaseGrid má načítať uložené settings, hardcoded šírky to prepíšu
Location: C:\Development\nex-automat\scripts\07_fix_invoice_list_widget.py
"""
...
WIDGET_FILE = DEV_ROOT / "apps" / "supplier-invoice-editor" / "src" / "ui" / "widgets" / "invoice_list_widget.py"
...
def fix_widget():
    ...
    print("=" * 80)
    print("FIX: invoice_list_widget.py")
    print("=" * 80)
    ...
    print("\nTeraz:")
    print("  1. Vymaž databázu: C:\\NEX\\YEARACT\\SYSTEM\\SQLITE\\grid_settings.db")
    print("  2. Spusti aplikáciu")
    print("  3. Nastav šírky podľa potreby")
    print("  4. Settings sa budú ukladať")
