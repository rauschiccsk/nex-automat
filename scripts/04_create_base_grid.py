#!/usr/bin/env python
"""
Create BaseGrid for shared-pyside6 package.
Phase 3-4 of PySide6 migration - Core + Enhanced features.
"""
...
def main():
    print("=" * 60)
    print("Phase 3-4: Creating BaseGrid for PySide6")
    print("=" * 60)

    # === BaseGrid ===
    create_file(PACKAGE_DIR / "ui" / "base_grid.py", '''"""
...
''')
    ...
    # === Test for BaseGrid ===
    create_file(TESTS_DIR / "test_base_grid.py", '''"""Tests for BaseGrid."""
import pytest
import tempfile
import os
from pathlib import Path
...
''')
    ...
    print()
    print("Created files:")
    print("  - shared_pyside6/ui/base_grid.py")
    print("  - shared_pyside6/ui/__init__.py (updated)")
    print("  - tests/test_base_grid.py")
    print()
    print("Run tests:")
    print("  cd packages/shared-pyside6")
    print("  python -m pytest tests/test_base_grid.py -v")
    print()
