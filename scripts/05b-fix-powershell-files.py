...
Prepíše start-claude-tools.ps1 a stop-claude-tools.ps1 so správnym encoding
"""

from pathlib import Path


def fix_powershell_files():
    """Prepíše PowerShell súbory so správnym obsahom"""

    print("\n" + "=" * 60)
    print("KROK 5b: Oprava PowerShell súborov")
    print("=" * 60 + "\n")

    tools_dir = Path("C:/Development/nex-automat/tools")

    # stop-claude-tools.ps1 - správny obsah
    stop_content = '''# Claude Tools - Stop Script (nex-automat)
...
'''
    ...
    # start-claude-tools.ps1 - len dôležitá časť na konci
    start_content = '''# Claude Tools - Startup Script (nex-automat)
...
'''
    ...
    # Uloz subory
    print("Prepisujem stop-claude-tools.ps1...")
    (tools_dir / "stop-claude-tools.ps1").write_text(stop_content, encoding='utf-8')
    print("  ✅ stop-claude-tools.ps1")

    print("\nPrepisujem start-claude-tools.ps1...")
    (tools_dir / "start-claude-tools.ps1").write_text(start_content, encoding='utf-8')
    print("  ✅ start-claude-tools.ps1")

    print("\n" + "=" * 60)
    print("✅ PowerShell subory opravene")
    print("=" * 60 + "\n")
