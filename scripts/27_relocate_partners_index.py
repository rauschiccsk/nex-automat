#!/usr/bin/env python3
"""
Script 27: Relocate partners/INDEX.md-old → PARTNERS_REFERENCE.md
...
def update_header(content: str) -> str:
    ...
    new_header = """# Partners Reference - Obchodní partneri
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 70)
    if success:
        print("✅ Migration complete - Partners index relocated")
        print("\nNext steps:")
