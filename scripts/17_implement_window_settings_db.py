"""
Implementuje window_settings_db.py modul
"""
from pathlib import Path

TARGET_FILE = Path("packages/nex-shared/database/window_settings_db.py")
...
def main():
    print("=" * 80)
    print("IMPLEMENTÁCIA: window_settings_db.py")
    print("=" * 80)
    ...
    print("\nFunkcie:")
    print("  ✅ WindowSettingsDB (singleton)")
    print("  ✅ save() - DELETE + INSERT pattern")
    print("  ✅ load() - SELECT s window_state")
    print("  ✅ delete() - DELETE window settings")
    print("  ✅ _init_db() - auto-create database")

    print("\n" + "=" * 80)
    print("ĎALŠÍ KROK:")
    print("=" * 80)
    print("Implementovať window_persistence.py")
    print("=" * 80)
