"""
Implementuje window_persistence.py modul
"""
from pathlib import Path

TARGET_FILE = Path("packages/nex-shared/ui/window_persistence.py")
...
def main():
    print("=" * 80)
    print("IMPLEMENTÁCIA: window_persistence.py")
    print("=" * 80)
    ...
    print("\nFunkcie:")
    print("  ✅ WindowPersistenceManager (singleton)")
    print("  ✅ validate_position() - validácia pozície")
    print("  ✅ get_monitor_geometry() - info o monitore")
    print("  ✅ find_monitor_for_position() - nájdi monitor")
    print("  ✅ get_safe_position() - bezpečná pozícia s fallback")
    print("  ✅ log_monitor_info() - debugging multi-monitor")

    print("\n" + "=" * 80)
    print("ĎALŠÍ KROK:")
    print("=" * 80)
    print("Implementovať base_window.py")
    print("=" * 80)
