"""
Debug: Add print statements to _load_grid_settings to see what's happening.
"""
import os
...
def main():
    ...
    print(f"SUCCESS: Added debug output to {TARGET_FILE}")
    print("Run the app and check console output")
    return True
