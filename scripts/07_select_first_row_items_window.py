"""
Select first row automatically after data load in InvoiceItemsWindow.
...
def main():
    ...
    # Add selectRow(0) after populate_model in _load_test_items
    ...
    if old_code not in content:
        print("ERROR: Could not find _load_test_items pattern")
        return False
