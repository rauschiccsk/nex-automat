...
Tenant-specific values (IČO, DIČ) are resolved via config/tenant.py.
"""
...
from nex_invoice_worker.adapters.base_adapter import BaseSupplierAdapter, SupplierConfig
...
# Tenant-specific MARSO IČO values
_SUPPLIER_ICO = {
    WorkerTenant.SUPPLIER: "10428342",
    WorkerTenant.ANDROS: "10428342215",
}

_SUPPLIER_DIC = {
    WorkerTenant.SUPPLIER: None,
    WorkerTenant.ANDROS: "HU10428342",
}
  ...
  <Message>
    ...
    def to_unified_invoice(self, raw_data: dict[str, Any]) -> UnifiedInvoice:
        ...
        return UnifiedInvoice(
            ...
            supplier_ico=_SUPPLIER_ICO[tenant],
            supplier_dic=_SUPPLIER_DIC[tenant],
